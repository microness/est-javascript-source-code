...
<html>
  ...
  <body>
    <h1>이 HTML은 브라우저에서 렌더링되지 않습니다.</h1>
    <p>왜냐하면 서버가 Content-Type을 text/plain으로 설정했기 때문입니다.</p>
  </body>
</html>
    `.trim());
  }
...
<html>
  ...
  <body>
    <h1>이 HTML은 브라우저에서 정상적으로 렌더링됩니다.</h1>
  </body>
</html>
    `.trim());
  }
...
<html>
  ...
  <body>
    ...
    <p>브라우저가 MIME 스니핑을 통해 HTML로 해석하지만, meta charset을 통해 UTF-8로 렌더링되도록 설정합니다.</p>
  </body>
</html>
  `.trim());
}
